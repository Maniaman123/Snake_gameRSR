...
function handleMobileControls() {
    // Remove swipe control references
    let currentControlType = 'buttons'; // Only buttons now
    ...
    function initControlDisplay() {
        ...
        toggleControlBtn.style.display = 'none'; // Hide the toggle button since we only have one control type
    }
